...
public class StoryManager {
    ...
    public StoryManager() {
        ...
        storyList.add(new Story("https://www.datocms-assets.com/55856/1636753460-information-overload.jpg?crop=focalpoint&fit=crop&fm=webp&fp-x=0.86&fp-y=0.47&h=428&w=856", "Live Chat: Breaking News Coverage", "Chat live with our reporters as they cover today's top stories in real time", "News Desk", "LIVE", "https://viafoura-mobile-demo.vercel.app", "test-livechat", Story.StoryType.liveChat));
    }
